...
import { type AccessibilityProps, type StyleProp, View, type ViewStyle } from "react-native";
...
type FrameProps = Pick<
  AccessibilityProps,
  "accessible" | "accessibilityRole" | "accessibilityLabel" | "accessibilityElementsHidden" | "importantForAccessibility"
> & {
  svg: LucideIcon;
  size: number;
  color?: string;
...
} satisfies StyledConfiguration<typeof Frame>;
