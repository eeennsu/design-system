...
const textPairs = (s: Scheme): [string, string, string][] => [
  ...
  ["fg.muted / bg.surface", s.fg.muted, s.bg.surface],
  ["fg.muted / bg.surface-muted (입력 칸 채움 위 placeholder, R26)", s.fg.muted, s.bg["surface-muted"]],
  ["fg.brand / bg.canvas (R26)", s.fg.brand, s.bg.canvas],
  ["fg.brand / bg.surface (R26)", s.fg.brand, s.bg.surface],
