...
export const Icon = ({ name, size = "md", tone = "default", label, className }) => {
    const Svg = icons[name];
    return (_jsx(Svg, { size: component.icon.size[size], role: label === undefined ? undefined : "img", "aria-label": label, "aria-hidden": label === undefined ? "true" : undefined, className: cn("shrink-0", tones[tone], className) }));
};
export { icons };
