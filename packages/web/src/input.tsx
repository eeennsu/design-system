...
export const controlBase =
  "block w-full bg-surface text-fg border border-border placeholder:text-fg-muted focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-border-focus";
