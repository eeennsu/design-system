...
- 구현 노트: [docs/implementation-notes.md](docs/implementation-notes.md). 진행 상태(**Phase 0~7 완료 — 2026-09-24 npm `0.1.0` publish**), 계획과 갈린 지점 16건, 구현 중 확인한 사실 20건이 여기 있다. 계획을 다시 읽기 전에 이걸 먼저 본다
