...
- 2026-09-05 R23 개정이 현재 기준. 스펙 상단 "R21 개정 요약"~"R23 개정 요약"과 Constraints 아래 "알려진 동작(v1)"을 먼저 읽는다. R20 미결 3건은 닫혔다(1·2 종결, 3은 C-19 착수 게이트). 결정 대기 항목 없음, 보류는 npm 스코프 이름뿐(`@<scope>` 변수)
